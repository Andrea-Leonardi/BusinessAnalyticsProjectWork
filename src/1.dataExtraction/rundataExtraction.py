...
COMPANY_SELECTION_SCRIPT = cfg.DATA_EXTRACTION_COMPANY_SELECTION_SCRIPT
REMAINING_PIPELINE_SCRIPTS = [
    cfg.DATA_EXTRACTION_PRICE_SCRIPT,
    cfg.DATA_EXTRACTION_FINANCIALS_GATHERING_SCRIPT,
    cfg.DATA_EXTRACTION_FINANCIALS_PROCESSING_SCRIPT,
    cfg.DATA_EXTRACTION_MERGE_SCRIPT,
]
